# 得意黑
本字体为开源字体，开源协议为 [OLF1.1](#许可证)
[Github 开源链接](https://github.com/atelier-anchor/smiley-sans)

以下内容为原作者[README文档](https://github.com/atelier-anchor/smiley-sans/blob/main/README.md)
---

<h1 align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="images/smiley-sans.dark.svg">
    <img src="images/smiley-sans.light.svg" alt="Smiley Sans" title="Smiley Sans">
  </picture>
</h1>
